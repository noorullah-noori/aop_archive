...
@section('content')
  <div class="portlet light">
    ...
    <div class="portlet-body">
      ...
      <div class="alert alert-warning"><i class="fa fa-exclamation-triangle" style="font-size:1.3em;"></i> {{$document->stock_edit_request_remarks}}</div>
      ...
      <div class="row">
        <a href="{{route('approve_request',$document->id)}}" class="btn btn-primary">تایید</a>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form role="form" class="form-horizontal" action="{{route('reject_request',$document->id)}}" method="post">
          {{csrf_field()}}
          <div class="form-body">
