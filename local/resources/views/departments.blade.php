                    ...
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                       <div class="caption">
                          ...
                          <span class="caption-subject font-green-sharp bold uppercase">تغییر دادن مرسل</span>
                       </div>
                     </div>
                         ...
                         <form role="form" class="form-horizontal" action="" method="post">
                          ...
                          <div class="form-body col-md-10 col-md-offset-1">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-md-10">
                                    <textarea name="department_description" id="description" class="form-control" rows="8" cols="80"></textarea>
                                  </div>
                              </div>
                          ...
                          <div class="form-actions">
                              <div class="row">
                                  <div class="col-md-offset-2 col-md-8" style="padding-right:10px;  margin-right: 24%;">
...
@push('custom-js')
  <script type="text/javascript">
    $('#department-datatable').DataTable({
      processing: true,
      serverSide: true,
      ajax: '{{route('get_department_datatable')}}',
      columns: [
          {data: 'id', name: 'id'},
          {data: 'name', name: 'name'},
     ...
     function openmodel(id){
       ...
       $.ajax({
        ...
        success: function(result) {
          $('form').attr('action',"{{url('departments')}}"+"/"+result['id']);
