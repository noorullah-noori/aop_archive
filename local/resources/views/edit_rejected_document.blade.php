...
@section('title','تصحیح سند رد شده')
@section('content')
  <div class="portlet light">
      ...
      @component('components.alert')
        ...
        @endslot
      @endcomponent
      <div class="alert alert-warning"><i class="fa fa-exclamation-triangle" style="font-size:1.3em;"></i> {{$document->remarks}}</div>
...
function confirmDelete(){
  ...
  $('#categories_id').change(function() {
    ...
    //   confirm('آیا مؤافق هستید این فایل را حذف نمایید؟')
    // })
