...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"اول",sLast:"آخر",sNext:"بعدی",sPrevious:"قبلی"},sEmptyTable:"هیچ موردی موجود نیست",sInfo:" نمایش _START_ تا _END_ از مجموع _TOTAL_ موارد",sInfoEmpty:"نمایش ۰ تا ۰ از ۰ مورد",sInfoFiltered:"(جستجو از مجموع _MAX_ موارد)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"نمایش _MENU_ مورد",sLoadingRecords:"در حال بارگزاری...",/*sProcessing:"در حال پروسس...",*/sSearch:"جستجو:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"موردی دریافت نشد"},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};X(m.defaults);m.defaults.column={aDataSort:null,
